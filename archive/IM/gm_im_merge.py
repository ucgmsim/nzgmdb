...
if year:
    ...
    mseed_year = ""
gmc_file = (
    "/Volumes/SeaJade 2 Backup/NZ/gmc_record/20231027_predictions/predictions_"
    + lower_mag
    + "-"
    + upper_mag
    + mseed_year
...
preferred_dir = (
    "/Volumes/SeaJade 2 Backup/NZ/mseed_"
    + lower_mag
    + "-"
    + upper_mag
    + mseed_year
...
pool = Pool(cores)
df_all = pd.concat(
    pool.starmap(get_gm_data, zip(file_list, itertools.repeat(preferred_dir))),
    ignore_index=True,
)
pool.close()
pool.join()
...
new_df[["score_mean_X", "fmin_mean_X", "multi_mean_X"]] = gmc_results[
    gmc_results.component == "X"
][
    [
        "score_mean",
        "fmin_mean",
...
new_df[["score_mean_Y", "fmin_mean_Y", "multi_mean_Y"]] = gmc_results[
    gmc_results.component == "Y"
][
    [
        "score_mean",
        "fmin_mean",
...
new_df[["score_mean_Z", "fmin_mean_Z", "multi_mean_Z"]] = gmc_results[
    gmc_results.component == "Z"
][
    [
        "score_mean",
        "fmin_mean",
...
gm_final.to_csv(
    directory
    + "IM_catalogue/ground_motion_im_catalogue_"
    + search_dir_year
    + lower_mag
    + "-"
    + upper_mag
