...
from nzgmdb.data_processing.clipnet.histogram import Histogram
from nzgmdb.data_processing.clipnet.max_amp import MaxAmp
from nzgmdb.data_processing.clipnet.ping import Ping
...
# Path to model data
NN_PATH = Path(__file__).parent / "clipnet"
